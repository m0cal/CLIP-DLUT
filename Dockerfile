...
RUN pip install fastapi uvicorn[standard] redis celery[redis] python-multipart pillow pydantic-settings transformers ftfy regex tqdm huggingface_hub hf_transfer
